                    ...
                    <div class="formcontainer">
                        <form id="form">
                	        ...
                	        <input type="password" name="pwd" id="password" placeholder="********" minlength="8" ><br>
               		        <p id="errorpassword">Il campo � vuoto inserisci la password</p>
						...
						<a href="login.jsp" style="cursor: pointer;">Hai gi� un account? Clicca qui per effettuare il login</a><br>
                    </div>
                </div>
            </div>
        </div>
